<template>
    <div id="node-container" style="margin: 0px 10px; border: 1px solid rgb(234, 234, 234); background-color: rgb(255, 255, 255);">
            ...
            <div class="uk-text-center">
                ...
                <div v-else>
                    ...
                    <div v-else style="text-align:left; text-transform: none;">
                        ...
                        <div v-else>
                            <!-- entry  -->
                            <div v-if="node.node_type == 3" style="padding-left: 15px; padding-bottom: 15px; padding-right: 15px;">
                             ...
                             <!-- folder  -->
                            <div v-if="node.node_type == 4" style="padding-left: 15px; padding-bottom: 15px; padding-right: 15px;">
                              folder {{  node.name  }}
                            </div>
        ...
        <div id="modal-upload" uk-modal="container:#node-container">
            <div style="padding-top:17px; width:60%; padding-bottom: 20px;" class="uk-modal-dialog uk-modal-body">
                ...
                <div style="padding: 10px; margin-top:10px;">
                    <uploader-component :parent="node.node_hash" place="channel" />
                </div>
            </div>
        </div>

                ...
                <div class="k-width-expand uk-text-right">
                    <div>
                        <router-link style="margin-right: 10px;" to="/channels/search/">
                            <button class="uk-button ffg-button-search " style="color:#000; font-weight: 500; padding:0px 10px;">
                                Search
                                <span style="color:#000;" class="uk-icon" uk-icon="icon: search"></span>
                            </button>
                        </router-link>
                        <button @click="openCreateChannelModal" class="uk-button ffg-button" style="width:190px; height:40px; ">
                            New Channel
            ...
            <div class="uk-text-center" style="padding-bottom: 20px;">
                <div v-if="loadingChannels" style="padding:0px 10px; text-align: center;">
                    <div style="border:1px solid #d7d7d7; border-radius: 2px;">
                        <div style="margin-top:50px;">
                            <span class="app-header2">Loading channels</span>
                        </div>
                        <div style="margin-top:18px; padding-bottom:30px;">
                            <div style="margin-top:35px;">
                                ...
                                <span class="normal-txt">Please wait while we load the channels</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-else>
                    <div v-if="channels.length <= 0" style="padding:0px 10px; text-align: center;">
                        <div style="border:1px solid #d7d7d7; border-radius: 2px;">
                            <div style="margin-top:50px;">
                                <span class="app-header2">No channels yet</span>
                            </div>
                            <div style="margin-top:18px; padding-bottom:30px;">
                                <div style="margin-top:35px;">
                                    <div class="uk-margin">
            ...
            <div class="uk-modal-dialog uk-modal-body">
                ...
                <div style="padding: 10px; margin-top:10px;">
                    <div style=" width:100%;" class="uk-inline">
                        ...
                        <input v-model="name" style="width:100%; border-radius: 4px; " class="uk-input normal-txt" type="text" placeholder="Channel Name" aria-label="Input">
                    </div>
                ...
                <div style="padding: 10px; margin-top:5px;">
                    <div style="width:100%;" class="uk-inline">
                        <textarea  v-model="description" class="uk-textarea normal-txt" rows="5" placeholder="Description" aria-label="Textarea"></textarea>
                    </div>
    ...
    methods: {
        ...
        async createChannel() {
            try {
                ...
                let admins = this.admins.split(',').map((o) => o.trim()).filter((o) => o && o!= "" && o.length == 42)
                
                let posters = this.posters.split(',').map((o) => o.trim()).filter((o) => o && o!= "" && o.length == 42)

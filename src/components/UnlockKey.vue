<template>
  ...
  import { SetJwtAccessToken, SetNodeAddress, SetNodeType, SetDownloadsPath, SetStoragePath, SetStorageAccessToken, SetStorageFees, SetRpcEndpoint, SetChannelOperationFees, SetStorageProviders} from '../store';
